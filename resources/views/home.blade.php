        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 bg-gray-300 p-8 rounded-lg">
            ...
            <div class="flex flex-col gap-3 items-center">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 justify-items-center items-center mb-5 lg:mb-0 gap-x-5">
                    <img loading="eager" class="w-28" src="{{asset('img/icons/php.png')}}" alt="php logo">
                    <img loading="eager" class="w-28" src="{{asset('img/icons/html.png')}}" alt="html5 logo">
                    <img loading="eager" class="w-28" src="{{asset('img/icons/css3.png')}}" alt="css3 logo">
                    <img loading="eager" class="w-28" src="{{asset('img/icons/javascript.png')}}" alt="javascript logo">
                    <img loading="eager" class="w-28" src="{{asset('img/icons/sql.png')}}" alt="sql logo">
                </div>
            </div>
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="grid grid-rows-2 grid-cols-2 justify-items-center items-center">
                    <img loading="eager" class="w-40 mr-5 sm:mr-0" src="{{asset('img/icons/Laravel.png')}}" alt="laravel logo">
                    <img loading="eager" class="w-60" src="{{asset('img/icons/Tailwind.png')}}" alt="tailwind logo">
                    <img loading="eager" class="w-44 self-start 2xl:self-auto" src="{{asset('img/icons/Sass.png')}}" alt="Sass logo">
                    <img loading="eager" class="w-16 md:w-20 lg:w-16 xl:w-20 2xl:w-24 self-start 2xl:self-auto" src="{{asset('img/icons/Livewire.png')}}" alt="livewire logo">
                </div>
            </div>
        </div>
    </main>
