    ...
    <header>
        ...
        <div class="principal rounded-lg min-h-screen flex items-center justify-center xl:justify-end">
            <div class="mb-[10%] flex flex-col items-center justify-center xl:items-end xl:justify-end">
                <h1 id="sideMovement" class="vanish sideMovement text-zinc-900 text-[4.5rem] md:text-[5rem] 2xl:text-[8rem] font-presentation uppercase font-bold xl:mx-16">
                    Pedro Amair
               </h1>
               <p class="vanish imagen text-transparent text-[3rem] 2xl:text-[5rem] font-presentation uppercase font-bold xl:mx-32 2xl:mx-36 mt-[-2rem] 2xl:mt-[-3rem]">
                    Web developer
               </p>
            </div>
        </div> 
