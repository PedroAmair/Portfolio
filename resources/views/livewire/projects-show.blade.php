  ...
  @switch($project)
    ...
    @case(3)
      ...
      <div class="bg-gray-200">
        ...
        <div class="flex justify-around pb-3">
          <div class="mb-6">
            <a class="bg-green-500 py-5 px-7 font-presentation text-lg rounded-full" href="https://fanal.co.cr/" target="_blank">{{__('messages.webpageButton')}}</a>
          </div>
        </div>
      </div>
      @break
      ...
      <div class="bg-gray-200">
        ...
        <div class="flex justify-around pb-3">
          <div class="mb-6">
            <a class="bg-green-500 py-5 px-7 font-presentation text-lg rounded-full" href="https://zack-services.com/" target="_blank">{{__('messages.webpageButton')}}</a>
          </div>
        </div>
      </div>
      @break
      ...
      <div class="bg-gray-200">
        ...
        <div class="flex justify-around pb-3">
          <div class="mb-6">
            <a class="bg-green-500 py-5 px-7 font-presentation text-lg rounded-full" href="https://www.bomberos.go.cr/" target="_blank">{{__('messages.webpageButton')}}</a>
          </div>
        </div>
      </div>
      @break
